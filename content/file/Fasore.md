...
Se 
$$
x(t)=X_msin(wt+\varphi_x)=X_m\cdot e^{j(wt+\varphi_x)}\implies\dot x = X_m\cdot e^{j\varphi_x}
$$
...
$$
\dot I_1\pm \dot I_2=\dot I_1+(\pm \dot I_2)
$$

- Proprietà di Derivata: 
$$
\dot Y= j w \dot x
$$

- Proprietà di Integrale: 
$$
\dot Y=\frac{\dot x}{jw}
$$
