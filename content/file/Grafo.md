...
Un __albero__ è un grafo non orientato nel quale due vertici qualsiasi sono connessi da uno e un solo cammino.
# Cammino e Ciclo
...
Un cammino $(v_0,...,v_k)$ tale che $v_0=v_k$ è detto __ciclo__ (va evitato).
