...
- [[#1 What is network security (8.1)|1 What is network security (8.1)]]
	- [[#1 What is network security (8.1)#1.1 Actors: Alice, Bob, Trudy|1.1 Actors: Alice, Bob, Trudy]]
		- [[#1.1 Actors: Alice, Bob, Trudy#1.1.1 Trudy|1.1.1 Trudy]]
- [[#2 Principles of cryptography (8.2)|2 Principles of cryptography (8.2)]]
	- [[#2 Principles of cryptography (8.2)#2.1 Language of cryptography|2.1 Language of cryptography]]
	- [[#2 Principles of cryptography (8.2)#2.2 Breaking encryption|2.2 Breaking encryption]]
	- [[#2 Principles of cryptography (8.2)#2.3 Symmetric Key cryptography (8.2.1)|2.3 Symmetric Key cryptography (8.2.1)]]
		- [[#2.3 Symmetric Key cryptography (8.2.1)#2.3.1 Stream ciphers|2.3.1 Stream ciphers]]
		- [[#2.3 Symmetric Key cryptography (8.2.1)#2.3.2 Block Ciphers|2.3.2 Block Ciphers]]
		- [[#2.3 Symmetric Key cryptography (8.2.1)#2.3.3 How entities establish a key|2.3.3 How entities establish a key]]
	- [[#2 Principles of cryptography (8.2)#2.4 Public Key Cryptography|2.4 Public Key Cryptography]]
		- [[#2.4 Public Key Cryptography#2.4.1 Public key Cryptography algorithms|2.4.1 Public key Cryptography algorithms]]
- [[#3 Message integrity (8.3)|3 Message integrity (8.3)]]
	- [[#3 Message integrity (8.3)#3.1 Message digests|3.1 Message digests]]
		- [[#3.1 Message digests#3.1.1 Internet checksum|3.1.1 Internet checksum]]
		- [[#3.1 Message digests#3.1.2 Hash function algorithms (8.3.1)|3.1.2 Hash function algorithms (8.3.1)]]
		- [[#3.1 Message digests#3.1.3 MAC: Message Authentication Code (8.3.2)|3.1.3 MAC: Message Authentication Code (8.3.2)]]
	- [[#3 Message integrity (8.3)#3.2 Digital signatures (8.3.3)|3.2 Digital signatures (8.3.3)]]
		- [[#3.2 Digital signatures (8.3.3)#3.2.1 CA: public key certification authorities|3.2.1 CA: public key certification authorities]]
- [[#4 Authentication (8.3)|4 Authentication (8.3)]]
	- [[#4 Authentication (8.3)#4.1 AP: Authentication Protocol|4.1 AP: Authentication Protocol]]
- [[#5 Securing e-mail (8.5)|5 Securing e-mail (8.5)]]
	- [[#5 Securing e-mail (8.5)#5.1 E-Mail authentication|5.1 E-Mail authentication]]
	- [[#5 Securing e-mail (8.5)#5.2 E-Mail Authentication and Message Integrity|5.2 E-Mail Authentication and Message Integrity]]
	- [[#5 Securing e-mail (8.5)#5.3 E-Mail Authentication, Integrity and Confidentiality|5.3 E-Mail Authentication, Integrity and Confidentiality]]
- [[#6 Securing TCP connections: TLS (8.6: SSL)|6 Securing TCP connections: TLS (8.6: SSL)]]
	- [[#6 Securing TCP connections: TLS (8.6: SSL)#6.1 Implementation|6.1 Implementation]]
		- [[#6.1 Implementation#6.1.1 T-TLS: initial Handshake|6.1.1 T-TLS: initial Handshake]]
		- [[#6.1 Implementation#6.1.2 T-TLS: cryptographic keys|6.1.2 T-TLS: cryptographic keys]]
		- [[#6.1 Implementation#6.1.3 T-TLS: encrypting data|6.1.3 T-TLS: encrypting data]]
		- [[#6.1 Implementation#6.1.4 T-TLS: connection close|6.1.4 T-TLS: connection close]]
	- [[#6 Securing TCP connections: TLS (8.6: SSL)#6.2 Transport-Layer Security (TLS)|6.2 Transport-Layer Security (TLS)]]
		- [[#6.2 Transport-Layer Security (TLS)#6.2.1 TLS Cipher suite|6.2.1 TLS Cipher suite]]
		- [[#6.2 Transport-Layer Security (TLS)#6.2.2 TLS 1.3 initial handshake|6.2.2 TLS 1.3 initial handshake]]
- [[#7 Network Layer Security: IPsec (8.7)|7 Network Layer Security: IPsec (8.7)]]
	- [[#7 Network Layer Security: IPsec (8.7)#7.1 Virtual Private Networks (VPNs)|7.1 Virtual Private Networks (VPNs)]]
	- [[#7 Network Layer Security: IPsec (8.7)#7.2 SAs: Security Associations (SAs) (8.7.3)|7.2 SAs: Security Associations (SAs) (8.7.3)]]
	- [[#7 Network Layer Security: IPsec (8.7)#7.3 IPsec datagram (8.7.4)|7.3 IPsec datagram (8.7.4)]]
	- [[#7 Network Layer Security: IPsec (8.7)#7.4 IPsec protocols (8.7.2)|7.4 IPsec protocols (8.7.2)]]
		- [[#7.4 IPsec protocols (8.7.2)#7.4.1 ESP tunnel mode: actions|7.4.1 ESP tunnel mode: actions]]
	- [[#7 Network Layer Security: IPsec (8.7)#7.5 IPsec sequence Numbers|7.5 IPsec sequence Numbers]]
	- [[#7 Network Layer Security: IPsec (8.7)#7.6 IPsec Security databases|7.6 IPsec Security databases]]
	- [[#7 Network Layer Security: IPsec (8.7)#7.7 IPsec Conclusions|7.7 IPsec Conclusions]]
- [[#8 Operational security: firewalls and IDS (8.9)|8 Operational security: firewalls and IDS (8.9)]]
	- [[#8 Operational security: firewalls and IDS (8.9)#8.1 Firewalls (8.9.1)|8.1 Firewalls (8.9.1)]]
		- [[#8.1 Firewalls (8.9.1)#8.1.1 Stateless packet filtering|8.1.1 Stateless packet filtering]]
		- [[#8.1 Firewalls (8.9.1)#8.1.2 Application Gateways|8.1.2 Application Gateways]]
		- [[#8.1 Firewalls (8.9.1)#8.1.3 Limitations of firewalls and gateways|8.1.3 Limitations of firewalls and gateways]]
		- [[#8.1 Firewalls (8.9.1)#8.1.4 IDS: Intrusion detection systems|8.1.4 IDS: Intrusion detection systems]]
