#uni 
La legge di Shockley definisce il valore della corrente totale che scorre in un diodo.
...
- $V_T$ è la tensione termica: $V_T=\frac{K_B\cdot T}{q}$, a temperatura vale circa $26\text{mV}$ 

[^1]: Per più informazioni leggere ([[Giunzione PN]]).
