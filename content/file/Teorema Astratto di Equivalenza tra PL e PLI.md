...
Quindi $convS \leq P$ quindi 
$$
 \begin{cases} max \ c^Tx \\ x \in S \end{cases} \leq \begin{cases} max \ c^Tx \\ x\in convS \end{cases} \leq \begin{cases} max \ c^Tx \\ x \in P \end{cases}
$$
