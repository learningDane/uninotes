#uni 
La progettazione concettuale è la prima fase del terzo stadio del [[Metodologie e Modelli Progettuali#Waterfall Model]], in particolare quella che porta alla realizzazione dello schema concettuale ([[Modello Entity-Relationship]]). A questa segue la [[Progettazione Logica]].
...
Quando si prende un caso particolare di una entity e lo si reifica, rendendolo sottoinsieme (quindi unico figlio) con una [generalizzazione](Modello%20Entity-Relationship.md#Generalizzazione) parziale.
...
1. si individuano i concetti principali e si realizza uno ___schema scheletro___:
   si individuano i concetti più importanti e li si organizza in un semplice schema concettuale
