...
Una volta preparato il file _utente/utente.cpp_ procedete a compilare tramite
...
In ogni caso, se lanciate _make_ senza aver fatto modifiche, il programma capirà che non è necessario ricompilare niente e ve lo dirà.

> MacOS usa una versione di make piuttosto vecchia, che può avere problemi ad interpretare correttamente il Makefile del nucleo. Quando abbiamo installato libce abbiamo installato anche una versione più recente di make, ma questa è stata installata con il nome ==_gmake_==. Potete usare _gmake_ al posto di make, oppure definire un alias.
...
# Debugger
Per usare il debugger è sufficiente passare il parametro _-g_ allo script _boot_:
