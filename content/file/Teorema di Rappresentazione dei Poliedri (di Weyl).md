...
scegliendo $s$ tale che $c\cdot v_s \geq c\cdot v_i, \forall i$  allora abbiamo che la soluzione ottimale della funzione obiettivo: 
$$
max_{x\in P} \ c\cdot x = c\cdot v_s
$$
