#uni 
Il problema dei potenziali su rete è il Duale della forma matriciale duale standard del [[Problema del Flusso di Costo Minimo]]: 
$$
(flusso \ minimo)\begin{cases} \min \quad
