...
La forza agente su un corpo è direttamente proporzionale all'accelerazione, ne condivide la direzione ed il verso, ed è direttamente proporzionale alla massa. 
$$
\vec F=m\vec a
$$
