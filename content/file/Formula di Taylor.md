...
$$
se \ f(x)=e^x :T_n(x)=\sum_{k=0}^n \frac{x^k}{k!} 
$$

$$
se \ f(x)=\sin x : T_{2n+1}(x)=\sum_{k=0}^n(-1)^k\frac{x^{2k+1}}{(2k+1)!}
$$

$$
se \ f(x)=\cos x : T_{2k}(x)=\sum_{k=0}^n(-1)^k\frac{x^{2k}}{(2k)!}
$$

$$
se \ f(x)=\log(1+x) : T_n(x)=\sum_{k=0}^n(-1)^{k+1}\frac{x^k}{k}
$$
