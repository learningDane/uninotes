...
$$
r:\quad( .. \ \{\tilde A_r\}\ ..)\cdot \begin{pmatrix}..\\ X_N \\ .. \end{pmatrix}\geq \{ X_r\}
$$
dove $\{ \}$ indica ___parte frazionaria___ e si calcola : $\{ C\}= C- \lfloor C \rfloor$ 
   ovvero = _numero_ - _arrotondamento per difetto_, che equivale all'aritmetica modulo 1.
